...
INSERT INTO flower (flo_name, flo_price, flo_toal_count, flo_avaiable_count, flo_failed_count, flo_sold_count, flo_buy_date, flo_note) VALUES
('Red Ecuador Rose', 35, 100, 85, 15, 0, '2026-08-08 07:00:00+07', 'Fresh import from night flower market, large blooms'),
('Purple Dutch Tulip', 45, 60, 50, 10, 0, '2026-08-09 08:30:00+07', 'Stored in cold room at 15C'),
('Blue Hydrangea', 60, 40, 38, 2, 0, '2026-08-09 08:30:00+07', 'Requires continuous misting'),
('White Dutch Baby Breath', 25, 80, 75, 5, 0, '2026-08-07 06:00:00+07', 'Used as filler flowers for main bouquet'),
('Da Lat Sunflower', 20, 50, 45, 5, 0, '2026-08-10 06:30:00+07', 'Thick stem, fresh branch');

-- 3. Seed Supply Inventory (supply)
INSERT INTO supply (sup_name, sup_price, sup_count, sup_sold_count, sup_buy_date, sup_note) VALUES
('Korean Sand White Wrapping Paper', 15, 200, 0, '2026-08-08 07:00:00+07', 'Waterproof quality material'),
('Cream Silk Ribbon', 8, 150, 0, '2026-08-08 07:00:00+07', 'Satin ribbon 4cm width'),
('Round Rattan Wooden Basket Size M', 55, 30, 0, '2026-08-09 09:00:00+07', 'Premium basket for grand opening arrangements'),
('Fleurs de Lilas Greeting Card', 5, 500, 0, '2026-08-07 06:00:00+07', 'Printed studio logo card attached to flowers'),
('Oasis Floral Foam', 12, 100, 0, '2026-08-09 08:30:00+07', 'Fast water-absorbing foam');
