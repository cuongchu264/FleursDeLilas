...
CREATE TABLE IF NOT EXISTS supply (
    ...
    sup_price NUMERIC(12,2) NOT NULL DEFAULT 0,
    sup_count INT NOT NULL DEFAULT 0,
    sup_sold_count INT NOT NULL DEFAULT 0,
    sup_buy_date TIMESTAMP WITH TIME ZONE,
...
CREATE TABLE IF NOT EXISTS fleurs_order (
    ...
    order_ship_price NUMERIC(12,2) NOT NULL DEFAULT 0,
