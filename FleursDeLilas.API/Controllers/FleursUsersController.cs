...
namespace FleursDeLilas.API.Controllers
{
    ...
    public class FleursUsersController : ControllerBase
    {
        private readonly IFleursUserQueryService _queryService;
        private readonly IFleursUserCommandService _commandService;

        public FleursUsersController(IFleursUserQueryService queryService, IFleursUserCommandService commandService)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateFleursUserDto dto)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] UpdateFleursUserDto dto)
        {
